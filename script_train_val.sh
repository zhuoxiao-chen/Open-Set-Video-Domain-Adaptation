...
#====== parameters ======#
dataset=ucf_olympic # hmdb_ucf | hmdb_ucf_small | ucf_olympic | gameplay_kinetics
...
then
  ...
  echo 'Printing parameters ... '
	...
	echo $class_file $modality $train_source_list $train_target_list $val_list --exp_path $exp_path \
	...
	-b $bS $bS_2 $bS -j 4 -ef 1 -pf 50 -sf 50 --copy_list N N \
